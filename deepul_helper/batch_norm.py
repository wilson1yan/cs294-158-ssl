...
# Standard BatchNorm with custom toggles of both learned scale and bias parameters
# (regular PyTorch batch norm toggles both or none, but not bias / scale individually)
...
class _NormBase(nn.Module):
    ...
    __constants__ = ['track_running_stats', 'momentum', 'eps', 'weight', 'bias',
                     ...
                     'num_features', 'center', 'scale']

    def __init__(self, num_features, eps=1e-5, momentum=0.1, center=True, scale=True,
    ...
    def extra_repr(self):
        return '{num_features}, eps={eps}, momentum={momentum}, center={center}, scale={scale}, ' \
...
class _BatchNorm(_NormBase):
    ...
    def __init__(self, num_features, eps=1e-5, momentum=0.1, center=True, scale=True,
        ...
        super(_BatchNorm, self).__init__(
            num_features, eps, momentum, center, scale, track_running_stats)
...
class BatchNorm1d(_BatchNorm):
    ...
    Args:
        ...
        center: a boolean value that when set to ``True``, this module has
            learnable center parameters. Default: ``True``
        scale: a boolean value that when set to ``True``, this module has
            learnable scale parameters. Default: ``True``
    ...
    Examples::
        ...
        >>> m = nn.BatchNorm1d(100, center=False, scale=False)
...
class BatchNorm2d(_BatchNorm):
    ...
    Examples::
        ...
        >>> # Without Learnable Parameters
        >>> m = nn.BatchNorm2d(100, center=False, scale=False)
...
class SyncBatchNorm(_BatchNorm):
    ...
    Examples::
        ...
        >>> # Without Learnable Parameters
        >>> m = nn.BatchNorm3d(100, center=False, scale=False, process_group=process_group)
    ...
    def __init__(self, num_features, eps=1e-5, momentum=0.1, center=True, scale=True,
        ...
        super(SyncBatchNorm, self).__init__(num_features, eps, momentum, center, 
                                            scale, track_running_stats)
